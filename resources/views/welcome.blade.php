...
.container {
  ...
  height: 100%;
  background: #ffffffff;
  background-image: radial-gradient(4px 100px at 0px 235px, #00ff55ff, #0000),
    radial-gradient(4px 100px at 300px 235px, #00ff55ff, #0000),
    radial-gradient(1.5px 1.5px at 150px 117.5px, #272257 100%, #0000 250%),
...
<div class="welcome-wrapper">
    <h1 class="welcome-title">Bem-vindo ao Stokki-Life</h1>
    <p class="welcome-subtitle">Controle seu estoque com agilidade, estilo e inteligência.</p>
